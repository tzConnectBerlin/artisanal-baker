...
if [ ! -z $SNAPSHOT ]; then
	...
	wget https://snapshots-tezos.giganode.io/snapshot-testnet_08-09-2020-01:49_706044_BLXnoyz8GyzZkCf3aCh3Uk7z3JNAbbkWwNxRatA77MTQEjgFoHM.rolling -O carthagenet.importme
